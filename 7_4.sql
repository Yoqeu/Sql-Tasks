...
select 'city' as table_name,  min(char_length(city_name)) as min,  max(char_length(city_name)) as max,  avg(char_length(city_name)) as average from city union all 
select 'univer' as table_name,  min(char_length(univer_name)) as min,  max(char_length(univer_name)) as max,  avg(char_length(univer_name)) as average from univer; 
